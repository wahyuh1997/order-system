<div class="container my-2">
  ...
  <section class="mt-3">
    <div class="card mb-3" style="max-width: 540px;">
          ...
          <div class="card-body py-2">
            ...
            <div class="row">
              <div class="col-5 my-auto">
                <h6 class="card-text text-dark-orange">Rp. 8000</h6>
              </div>
              <div class="col-7 ps-0">
                <div class="row">
                  ...
                  <div class="col-3 px-0 text-center my-auto">
                    <button type="button" class="btn btn-sm btn-outline-orange btn-round">
      ...
      <div class="row g-0">
        ...
        <div class="col-9">
          <div class="card-body py-2">
            <h6 class="card-title text-dark-orange">Cookies Choco Chip</h6>
            <div class="row">
              <div class="col-5 my-auto">
                <h6 class="card-text text-dark-orange">Rp. 8000</h6>
              </div>
  ...
  <section class="d-grid gap-2 mt-2">
    <button class="btn btn-sm btn-outline-darkorange">Tambahkan Produk Lain</button>
  </section>
  ...
  <!-- Order Button -->
  <section class="d-grid gap-2 mt-2">
    <a href="<?= base_url('order/payment'); ?>" class="btn btn-orange">Pesan</a>
  </section>
</div>